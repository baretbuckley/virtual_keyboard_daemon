...
enum KeyCode {
    ...
    K_LShift              = SELECT_KEY( KEY_LEFTSHIFT,              VK_SHIFT ),
    K_RShift              = SELECT_KEY( KEY_RIGHTSHIFT,             VK_SHIFT ),
    ...
    K_LControl            = SELECT_KEY( KEY_LEFTCTRL,               VK_CONTROL ),
    K_RControl            = SELECT_KEY( KEY_RIGHTCTRL,              VK_CONTROL ),
    ...
    K_LAlt                = SELECT_KEY( KEY_LEFTALT,                VK_MENU ),
    K_RAlt                = SELECT_KEY( KEY_RIGHTALT,               VK_MENU ),
